...
def _banner():
    ...
    print(f"  Local AI — RAG + Skills — your data stays private")
    print(f"{'='*54}\n")
...
def server_cmd():
    ...
    parser = argparse.ArgumentParser(prog="zettabrain-lite",
                                     description="Launch ZettaBrain Lite")
    ...
    print(f"  Starting ZettaBrain Lite...")
